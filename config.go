...
func loadConfig() Config {
	...
	connectionMode := strings.ToLower(env("FLEET_CONNECTION_MODE", "auto"))
	...
	return Config{
		...
		FleetConnectionMode: connectionMode,
...
func isConnectionMode(value string) bool {
	switch value {
	case "auto", "kubeconfig", "in-cluster", "direct", "demo":
		return true
	default:
		return false
	}
